package com.learning.springboot.devrestapi.aop;

import javax.servlet.http.HttpServletRequest;
import javax.xml.bind.DatatypeConverter;

import com.learning.springboot.devrestapi.service.SecurityServiceImpl;
...
public class UserTokenRequiredAspect {
    ...
    @Before(value = "@annotation(userTokenRequired)")
